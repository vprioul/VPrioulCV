...
public class FeatureProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":feature:hobbies"
     */
    public Feature_HobbiesProjectDependency getHobbies() { return new Feature_HobbiesProjectDependency(getFactory(), create(":feature:hobbies")); }
