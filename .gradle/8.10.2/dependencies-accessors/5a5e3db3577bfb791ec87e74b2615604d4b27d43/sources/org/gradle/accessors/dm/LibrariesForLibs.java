...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Group of libraries at <b>collection</b>
     */
    ...
    public static class CollectionLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>immutable</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getImmutable() {
            return create("collection.immutable");
        }

    }

    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        private final ComposeIconLibraryAccessors laccForComposeIconLibraryAccessors = new ComposeIconLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>compose.icon</b>
         */
        public ComposeIconLibraryAccessors getIcon() {
            return laccForComposeIconLibraryAccessors;
        }
    ...
    public static class ComposeIconLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public ComposeIconLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>icon</b> with <b>androidx.compose.material:material-icons-core</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("compose.icon");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getExtended() {
            return create("compose.icon.extended");
        }
    ...
    public static class ComposeUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public Provider<MinimalExternalModuleDependency> getFonts() {
            return create("compose.ui.fonts");
        }
    ...
    public static class DetektLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compose</b> with <b>io.nlopez.compose.rules:detekt</b> coordinates and
         * with version reference <b>detektCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("detekt.compose");
        }
        ...
        /**
         * Dependency provider for <b>gradlePlugin</b> with <b>io.gitlab.arturbosch.detekt:detekt-gradle-plugin</b> coordinates and
         * with version reference <b>detekt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGradlePlugin() {
            return create("detekt.gradlePlugin");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxComposeCompiler</b> with value <b>1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>detektCompose</b> with value <b>0.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDetektCompose() { return getVersion("detektCompose"); }

        /**
         * Version alias <b>detektFormatting</b> with value <b>1.23.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>immutable</b> with value <b>0.3.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getImmutable() { return getVersion("immutable"); }
        ...
        /**
         * Version alias <b>sonarCloud</b> with value <b>3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSonarCloud() { return getVersion("sonarCloud"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final FeaturePluginAccessors paccForFeaturePluginAccessors = new FeaturePluginAccessors(providers, config);
         ...
         * with version reference <b>sonarCloud</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Group of plugins at <b>plugins.feature</b>
         */
        public FeaturePluginAccessors getFeature() {
            return paccForFeaturePluginAccessors;
        }
    ...
    public static class AndroidPluginAccessors extends PluginFactory {
        private final AndroidApplicationPluginAccessors paccForAndroidApplicationPluginAccessors = new AndroidApplicationPluginAccessors(providers, config);
        private final AndroidLibraryPluginAccessors paccForAndroidLibraryPluginAccessors = new AndroidLibraryPluginAccessors(providers, config);

        public AndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>android.detekt</b> with plugin id <b>plugin.android.detekt</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getDetekt() { return createPlugin("android.detekt"); }

        /**
         * Group of plugins at <b>plugins.android.application</b>
         */
        public AndroidApplicationPluginAccessors getApplication() {
            return paccForAndroidApplicationPluginAccessors;
        }

        /**
         * Group of plugins at <b>plugins.android.library</b>
         */
        public AndroidLibraryPluginAccessors getLibrary() {
            return paccForAndroidLibraryPluginAccessors;
        }

    }

    public static class AndroidApplicationPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public AndroidApplicationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
         ...
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("android.application"); }

        /**
         * Plugin provider for <b>android.application.compose</b> with plugin id <b>plugin.android.application.compose</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("android.application.compose"); }

        /**
         * Plugin provider for <b>android.application.flavor</b> with plugin id <b>plugin.android.flavors</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getFlavor() { return createPlugin("android.application.flavor"); }

        /**
         * Plugin provider for <b>android.application.project</b> with plugin id <b>plugin.android.application</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getProject() { return createPlugin("android.application.project"); }

    }

    public static class AndroidLibraryPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public AndroidLibraryPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
         ...
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("android.library"); }

        /**
         * Plugin provider for <b>android.library.compose</b> with plugin id <b>plugin.android.library.compose</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("android.library.compose"); }

        /**
         * Plugin provider for <b>android.library.project</b> with plugin id <b>plugin.android.library</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getProject() { return createPlugin("android.library.project"); }

    }

    public static class FeaturePluginAccessors extends PluginFactory {

        public FeaturePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>feature.data</b> with plugin id <b>plugin.android.feature.data</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getData() { return createPlugin("feature.data"); }

        /**
         * Plugin provider for <b>feature.domain</b> with plugin id <b>plugin.android.feature.domain</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getDomain() { return createPlugin("feature.domain"); }

        /**
         * Plugin provider for <b>feature.ui</b> with plugin id <b>plugin.android.feature.ui</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getUi() { return createPlugin("feature.ui"); }

    }

    public static class HiltPluginAccessors extends PluginFactory  implements PluginNotationSupplier{
         ...
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("hilt"); }

        /**
         * Plugin provider for <b>hilt.project</b> with plugin id <b>plugin.android.hilt</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getProject() { return createPlugin("hilt.project"); }
