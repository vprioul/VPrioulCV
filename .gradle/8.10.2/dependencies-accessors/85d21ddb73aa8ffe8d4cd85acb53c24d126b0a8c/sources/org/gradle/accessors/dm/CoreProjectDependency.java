...
public class CoreProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":core:share"
     */
    public Core_ShareProjectDependency getShare() { return new Core_ShareProjectDependency(getFactory(), create(":core:share")); }
