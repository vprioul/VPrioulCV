...
@NonNullApi
public class VPrioulCVProjectDependency extends DelegatingProjectDependency {

    @Inject
    public VPrioulCVProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
