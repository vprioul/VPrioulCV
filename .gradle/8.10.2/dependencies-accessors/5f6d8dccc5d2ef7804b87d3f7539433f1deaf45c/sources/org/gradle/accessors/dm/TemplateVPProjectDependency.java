...
@NonNullApi
public class TemplateVPProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TemplateVPProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
